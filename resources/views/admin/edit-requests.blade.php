...
<main class="h-full pb-16 overflow-y-auto">
          ...
          <div class="container grid px-6 mx-auto">
           <br>
            ...
            @csrf
              <input type="text" name="code" id="search" style="width: 100%;padding: 12px 20px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;" placeholder="Search By Code" /><br><br>
